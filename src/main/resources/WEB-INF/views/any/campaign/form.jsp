...
<acme:form>
	...
	<acme:button code="any.campaign.form.button.milestones" action="/any/part/list?campaignId=${id}"/>
	<acme:button code="any.campaign.form.button.spokesperson" action="/any/campaign/show?id=${campaignId}"/>
</acme:form>